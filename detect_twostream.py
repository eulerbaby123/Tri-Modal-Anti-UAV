...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r"C:\Users\xwj\Desktop\multispectral-object-detection-main\runs\train\exp14\weights\best.pt", help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default=r"D:\uavdata\align\val_rgb.txt", help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default=r"D:\uavdata\align\val_ir.txt", help='source')  # file/folder, 0 for webcam
